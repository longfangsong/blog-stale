---
title: Rapid Object Detection Using a Boosted Cascade of Simple Features翻译
date: 2018-04-19 00:00:00
tags: [机器视觉, AI, 论文翻译]
mathjax: true
comments: true
summary: 本文介绍了一种用于视觉对象检测的机器学习方法，该方法能够非常快速地处理图像并实现高检测率。这项工作有三个重要贡献。首先是引入一种称为积分图的新图像表示，它可以使我们的检测器使用的特征能够非常快地计算出来。第二种是基于AdaBoost的学习算法，它从较大的集合中选择少量的关键视觉特征并生成极其有效的分类器。第三个贡...
---
<h2 id="原文链接"><a class="headerlink" href="#原文链接" title="原文链接"></a>原文链接</h2><p><a href="https://ieeexplore.ieee.org/document/990517" rel="noopener" target="_blank">https://ieeexplore.ieee.org/document/990517</a></p>
 hexo-inject:begin  hexo-inject:end <h2 id="原作者"><a class="headerlink" href="#原作者" title="原作者"></a>原作者</h2><p>Viola, P.; Jones, M.</p>
